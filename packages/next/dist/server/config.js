...
function assignDefaults(userConfig) {
    ...
    if (typeof ((ref11 = userConfig.experimental) === null || ref11 === void 0 ? void 0 : ref11.reactMode) !== 'undefined') {
        var ref6;
    ...
    if (result === null || result === void 0 ? void 0 : result.images) {
        ...
        if (images.domains) {
            ...
            // this resource
            if ((ref10 = config.assetPrefix) === null || ref10 === void 0 ? void 0 : ref10.startsWith('http')) {
