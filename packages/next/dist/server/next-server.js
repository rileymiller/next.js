...
class NextNodeServer extends _baseServer.default {
   ...
   */ getEdgeFunctionInfo(params) {
        ...
        try {
            ...
            throw (0, _require).pageNotFoundError(params.page);
        }
   ...
   */ async runMiddleware(params) {
        ...
        const normalizedPathname = (0, _removeTrailingSlash).removeTrailingSlash(params.parsedUrl.pathname);
    ...
    generateCatchAllMiddlewareRoute() {
        ...
        return {
            ...
            fn: async (req, res, _params, parsed)=>{
                ...
                const normalizedPathname = (0, _removeTrailingSlash).removeTrailingSlash(parsedUrl.pathname);
    ...
    async runEdgeFunctionApiEndpoint(params) {
        let middlewareInfo;
        try {
