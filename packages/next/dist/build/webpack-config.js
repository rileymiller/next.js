...
async function getBaseWebpackConfig(dir, { buildId , config , compilerType , dev =false , entrypoints , hasReactRoot , isDevFallback =false , pagesDir , reactProductionProfiling =false , rewrites , runWebpackSpan , target ='server' , appDir  }) {
                    ...
                    new TerserPlugin({
                        ...
                        terserOptions: {
                            ...
                            compress: {
                                ...
                                ...(ref44 = (ref = config.experimental.swcMinifyDebugOptions) === null || ref === void 0 ? void 0 : ref.compress) !== null && ref44 !== void 0 ? ref44 : {}
                            },
                            mangle: {
                                ...terserOptions.mangle,
                                ...(ref45 = (ref43 = config.experimental.swcMinifyDebugOptions) === null || ref43 === void 0 ? void 0 : ref43.mangle) !== null && ref45 !== void 0 ? ref45 : {}
                            }
                        }
                    }).apply(compiler);
                },
    ...
    const cache = {
        ...
        version: `${"12.1.7-canary.26"}|${configVars}`,
