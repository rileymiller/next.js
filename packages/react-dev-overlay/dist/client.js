...
exports.onRefresh = exports.unregister = exports.register = exports.onFullRefreshNeeded = exports.onBuildError = exports.onBuildOk = exports.ReactDevOverlay = exports.getNodeError = exports.getErrorByType = void 0;
...
function onFullRefreshNeeded(reason) {
    Bus.emit({ type: Bus.TYPE_FULL_REFRESH_NEEDED, reason: reason !== null && reason !== void 0 ? reason : null });
}
exports.onFullRefreshNeeded = onFullRefreshNeeded;
function onRefresh() {
    Bus.emit({ type: Bus.TYPE_REFRESH });
}
exports.onRefresh = onRefresh;
var getErrorByType_1 = require("./internal/helpers/getErrorByType");
__createBinding(exports, getErrorByType_1, "getErrorByType");
