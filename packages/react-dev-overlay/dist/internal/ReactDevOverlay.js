...
var FullRefreshWarning_1 = require("./container/FullRefreshWarning");
...
function reducer(state, ev) {
    switch (ev.type) {
        ...
        case Bus.TYPE_FULL_REFRESH_NEEDED: {
            var aboutToRefreshNewState = __assign(__assign({}, state), { fullRefreshReason: null, isAboutToFullRefresh: true });
            if (ev.reason === null) {
                return aboutToRefreshNewState;
            }
            return __assign(__assign({}, aboutToRefreshNewState), { fullRefreshReason: ev.reason });
        }
...
var ReactDevOverlay = function ReactDevOverlay(_a) {
    var children = _a.children, preventDisplay = _a.preventDisplay;
    ...
    var isAboutToFullRefresh = state.isAboutToFullRefresh;
    var isMounted = hasBuildError || hasRuntimeErrors || isAboutToFullRefresh;
    return (React.createElement(React.Fragment, null,
        ...
        isMounted ? (React.createElement(ShadowPortal_1.ShadowPortal, null,
            ...
            shouldPreventDisplay(hasBuildError
                ? 'build'
                : hasRuntimeErrors
                    ? 'runtime'
                    : isAboutToFullRefresh
                        ? 'full-refresh'
                        : null, preventDisplay) ? null : hasBuildError ? (React.createElement(BuildError_1.BuildError, { message: state.buildError })) : hasRuntimeErrors ? (React.createElement(Errors_1.Errors, { errors: state.errors })) : isAboutToFullRefresh ? (React.createElement(FullRefreshWarning_1.FullRefreshWarning, { reason: state.fullRefreshReason })) : undefined)) : undefined));
};
var shouldPreventDisplay = function (errorType, preventType) {
