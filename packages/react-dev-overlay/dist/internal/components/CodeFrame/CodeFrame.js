...
var CodeFrame = function CodeFrame(_a) {
    ...
    return (React.createElement("div", { "data-nextjs-codeframe": true },
        ...
        React.createElement("pre", null, decoded.map(function (entry, index) { return (React.createElement("span", { key: "frame-".concat(index), style: __assign({ color: entry.fg ? "var(--color-".concat(entry.fg, ")") : undefined }, (entry.decoration === 'bold'
                ? { fontWeight: 800 }
