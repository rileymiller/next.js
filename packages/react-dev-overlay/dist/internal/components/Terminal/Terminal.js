...
var Terminal = function Terminal(_a) {
    ...
    return (React.createElement("div", { "data-nextjs-terminal": true },
        React.createElement("pre", null, decoded.map(function (entry, index) { return (React.createElement("span", { key: "terminal-entry-".concat(index), style: __assign({ color: entry.fg ? "var(--color-".concat(entry.fg, ")") : undefined }, (entry.decoration === 'bold'
                ? { fontWeight: 800 }
