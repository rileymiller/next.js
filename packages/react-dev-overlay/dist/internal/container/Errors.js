...
var getErrorByType_1 = require("../helpers/getErrorByType");
...
function getErrorSignature(ev) {
    ...
    switch (event.type) {
        ...
        case bus_1.TYPE_UNHANDLED_REJECTION: {
            return "".concat(event.reason.name, "::").concat(event.reason.message, "::").concat(event.reason.stack);
        }
        default: {
        }
    }
    ...
    return (React.createElement(React.Fragment, null, linkRegex.test(text)
        ? text.split(' ').map(function (word, index, array) {
            if (linkRegex.test(word)) {
                return (React.createElement(React.Fragment, { key: "link-".concat(index) },
                    React.createElement("a", { href: word }, word),
                    index === array.length - 1 ? '' : ' '));
            }
            return index === array.length - 1 ? (React.createElement(React.Fragment, { key: "text-".concat(index) }, word)) : (React.createElement(React.Fragment, { key: "text-".concat(index) },
                word,
                " "));
        })
        : text));
...
var Errors = function Errors(_a) {
    ...
    React.useEffect(function () {
        ...
        var mounted = true;
        (0, getErrorByType_1.getErrorByType)(nextError).then(function (resolved) {
    ...
    var isServerError = (0, nodeStackFrames_1.isNodeError)(activeError.error);
    return (React.createElement(Overlay_1.Overlay, null,
