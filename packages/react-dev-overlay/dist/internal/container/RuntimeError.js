...
var CallStackFrame = function CallStackFrame(_a) {
    ...
    var open = React.useCallback(function () {
        ...
        self
            .fetch("".concat(process.env.__NEXT_ROUTER_BASEPATH || '', "/__nextjs_launch-editor?").concat(params.toString()))
...
var RuntimeError = function RuntimeError(_a) {
    ...
    return (React.createElement(React.Fragment, null,
        firstFrame ? (React.createElement(React.Fragment, null,
            ...
            leadingFrames.map(function (frame, index) { return (React.createElement(CallStackFrame, { key: "leading-frame-".concat(index, "-").concat(all), frame: frame })); }),
        ...
        visibleCallStackFrames.length ? (React.createElement(React.Fragment, null,
            ...
            visibleCallStackFrames.map(function (frame, index) { return (React.createElement(CallStackFrame, { key: "call-stack-".concat(index, "-").concat(all), frame: frame })); }))) : undefined,
