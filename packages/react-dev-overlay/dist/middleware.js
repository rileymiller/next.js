...
exports.getOverlayMiddleware = exports.getSourceById = exports.createOriginalStackFrame = exports.parseStack = void 0;
...
__createBinding(exports, parseStack_1, "parseStack");
            ...
            switch (_a.label) {
                ...
                case 2:
                    try {
                        ...
                        console.error("Failed to lookup module by ID (\"".concat(id, "\"):"), err);
                        return [2 /*return*/, null];
                    }
                    return [2 /*return*/];
            }
